// ======================================================================
// Thermistor_Lab.v generated from TopDesign.cysch
// 06/18/2023 at 18:21
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4da6847c-9c12-43ed-9d51-d5182c69477f/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("661fd630-b2b1-46f0-91db-c66ec8662d3d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 PWR_5V (
        .connect({
            Net_10
        })
    );
    defparam PWR_5V.comp_name = "Power_v1_0";
    defparam PWR_5V.port_names = "T1";
    defparam PWR_5V.width = 1;
	...
	wire [0:0] tmpOE__Pin3_2_net;
	wire [0:0] tmpFB_0__Pin3_2_net;
	wire [0:0] tmpIO_0__Pin3_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_2_net;
	electrical [0:0] tmpSIOVREF__Pin3_2_net;

	cy_psoc3_pins_v1_10
		#(.id("a995b1cf-1320-4708-bbca-72ae0700e916"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_2
		 (.oe(tmpOE__Pin3_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_2_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__Pin3_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_2_net[0:0]}),
		  .annotation({Net_10}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin3_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_1 LCD_Char_1 ();

	wire [0:0] tmpOE__Pin3_3_net;
	wire [0:0] tmpFB_0__Pin3_3_net;
	wire [0:0] tmpIO_0__Pin3_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_3_net;
	electrical [0:0] tmpSIOVREF__Pin3_3_net;

	cy_psoc3_pins_v1_10
		#(.id("80fe0b2a-9018-4760-9823-5d5a259b7dea"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_3
		 (.oe(tmpOE__Pin3_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_3_net[0:0]}),
		  .analog({Net_33}),
		  .io({tmpIO_0__Pin3_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_3_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin3_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin3_4_net;
	wire [0:0] tmpFB_0__Pin3_4_net;
	wire [0:0] tmpIO_0__Pin3_4_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_4_net;
	electrical [0:0] tmpSIOVREF__Pin3_4_net;

	cy_psoc3_pins_v1_10
		#(.id("80fda590-7e08-401e-b956-57c9b28cafa7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_4
		 (.oe(tmpOE__Pin3_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_4_net[0:0]}),
		  .analog({Net_8}),
		  .io({tmpIO_0__Pin3_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_4_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin3_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
